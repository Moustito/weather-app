...
searchLocation.addEventListener("keyup", (event) => {
  ...
  } else if (document.getElementById("searchLocation") == "") {
...
function displayMenuAutocomplete() {
  ...
  searchBar.appendChild(divCountry);
  divCountry.id = "divCountry";

  let countryList = document.createElement("ul");
  divCountry.appendChild(countryList);

  let country = document.createElement("li");
  countryList.appendChild(country);
  let countryText = document.createTextNode("element.name");
